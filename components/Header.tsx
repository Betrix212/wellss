import { Box, Button, List, ListItem, Link, Input } from "@mui/material";
...
export const Header: React.FC<HeaderProps> = () => {
  ...
  const showMenu = !pathname.includes("/s/");
  const isPhone = useMediaQuery("(max-width: 569px)");
              ...
              <>
                {isPhone ? (
                  ...
                  >
                    ...
                    >
                      <MenuLink text="Enroll" icon={<LockIcon />} />
                      <MenuLink text="Customer Service" />
                      <MenuLink text="ATMs/Locations" />
                      <MenuLink text="Español" />
                    </List>
                    <Box
                      sx={{
                        paddingLeft: "16px",
...
const MenuLink = ({ text, icon }: { text: string; icon?: any }) => {
  return (
    <ListItem
      sx={{
        margin: 0,
...
const Logo = () => {
  ...
  return (
    <svg
      ...
      focusable="false"
      style={{
        width: isPhone ? "148px" : "211px",
        height: isPhone ? "16px" : "22px",
      }}
    >
      <path
        fill="#ffffff"
